...
<div class="main_body">
   ...
   <div class="container1">
      ...
      <div class="profile1">
         <?php
            $select1 = mysqli_query($conn,"SELECT * FROM `courses` WHERE course_teacher_id = '$user_id'") or die('query failed');
         ...
         <h3 style="display: inline-block;">Total Number of Courses : <h4 style="display: inline-block;"><?php echo $fetch['total_number_courses']; ?></h4></h3>
